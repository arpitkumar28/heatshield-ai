...
export default function DataVisualization({ title = 'Data Visualization' }: DataVisualizationProps) {
...
function ChartTypeButton({ icon, label, active, onClick }: ChartTypeButtonProps) {
  return (
    <button
      onClick={onClick}
