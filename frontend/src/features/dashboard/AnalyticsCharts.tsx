    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-xl border border-white/10">
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h3 className="text-lg font-semibold text-white font-display">24-Hour Heat Trend</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card rounded-xl border border-white/10">
          <div className="flex items-center justify-between p-6 border-b border-white/10">
            <h3 className="text-lg font-semibold text-white font-display">NDVI Trend (8 Weeks)</h3>
            <div className="flex items-center gap-2">
        ...
        <div className="glass-card rounded-xl border border-white/10">
          <div className="flex items-center justify-between p-6 border-b border-white/10">
            <h3 className="text-lg font-semibold text-white font-display">Risk Distribution</h3>
          </div>
          <div className="p-6 h-64">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
      ...
      <div className="glass-card rounded-xl border border-white/10">
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h3 className="text-lg font-semibold text-white font-display">Vulnerability by City</h3>
        </div>
        <div className="p-6 h-64">
          <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="glass-card rounded-xl border border-white/10">
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h3 className="text-lg font-semibold text-white font-display">Intervention ROI Analysis</h3>
        </div>
        <div className="p-6 h-64">
          <ResponsiveContainer width="100%" height="100%">
