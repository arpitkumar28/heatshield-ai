...
export default function MobileIntegration() {
  ...
  const deviceBreakdown = [
    { platform: 'Android', count: 856, percentage: '68.7%', status: 'active' as const },
    { platform: 'iOS', count: 389, percentage: '31.3%', status: 'active' as const },
  ]
...
function AlertStatCard({ title, value, trend }: AlertStatCardProps) {
  return (
    <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-xl p-4 border border-white/10">
...
function AlertConfig({ title, description, enabled }: AlertConfigProps) {
  return (
...
function DeviceCard({ platform, count, percentage, status }: DeviceCardProps) {
  return (
    <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-xl p-4 border border-white/10">
...
interface DeviceManagementItemProps {
  icon: React.ReactNode
  title: string
  status: string
  description: string
...
function DeviceManagementItem({ icon, title, status, description }: DeviceManagementItemProps) {
  return (
    <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg">
      {icon}
      <div className="flex-1">
