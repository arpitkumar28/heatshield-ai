...
import { Layers, Clock, MapPin, Activity, Info, X } from 'lucide-react'
import { GISMap, MapErrorBoundary, LayerPanel, SearchPanel, InsightsPanel, TimelinePanel } from '@/features/gis'
...
export default function GISWorkspace({ center, heatData, selectedCity, onCityChange }: GISWorkspaceProps) {
  ...
  const handleLayerChange = (layer: 'lst' | 'ndvi' | 'heatIndex') => {
