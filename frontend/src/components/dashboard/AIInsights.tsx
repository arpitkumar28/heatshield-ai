...
const recommendations = [
  ...
  },
  {
    ...
    title: 'Emergency Water Stations',
    location: 'Low-income areas, Chennai',
    description: 'Install 30 emergency water stations in identified heat-vulnerable neighborhoods. Each station to serve approximately 5,000 residents daily.',
    impact: '150K citizens served',
    cost: '₹3.5 Cr',
    timeline: '1 month',
    confidence: 89,
    actions: [
      'Map vulnerable neighborhoods',
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-text-muted">Government-grade action items</p>
          </div>
        </div>
      ...
      {recommendations.map((rec) => (
        <div key={rec.id} className="glass-card rounded-xl p-5 border border-white/10 hover:border-primary/30 transition-all">
